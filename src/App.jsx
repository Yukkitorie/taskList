...
function App() {
  ...
  const [sortType, setSortType] = useState("date"); // Priority or Date
  const [sortOrder, setSortOrder] = useState("asc"); // !asc = decs
...
function CompletedTasksLits({ completedTasks, deleteTask }) {
  return (
